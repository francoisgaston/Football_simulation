...
public class Main {
    public static void main(String[] args) {
        ...
        velocity_variation(inicio_intervalo, fin_intervalo, tao, Local, Visitante);
    }

    public static void oneSimulation(int inicio_intervalo, int fin_intervalo, double v_deseada, double tao, double[][] Local, double[][] Visitante){
    ...
    public static void Simulation_wrapper(int inicio_intervalo, int fin_intervalo, double v_deseada, double tao, String OutputPath, double[][] Local, double[][] Visitante){
